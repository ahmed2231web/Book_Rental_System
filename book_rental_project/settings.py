...
ROOT_URLCONF = 'book_rental_project.urls'
...
WSGI_APPLICATION = 'book_rental_project.wsgi.application'
...
if os.getenv('USE_POSTGRESQL', 'false').lower() == 'true':
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DATABASE_NAME', 'book_rental_db'),
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API for an online book rental platform.',
    'VERSION': '1.0.0',
